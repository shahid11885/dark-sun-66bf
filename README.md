...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/dark-sun-66bf)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dark-sun-66bf
```

A live public deployment of this template is available at [https://dark-sun-66bf.templates.workers.dev](https://dark-sun-66bf.templates.workers.dev)
